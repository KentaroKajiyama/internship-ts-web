...
import { AddTagsOfCheckedInCreateTodo } from '@/infrastructure/repository/tag/AddTagsOfCheckedInCreateTodo';
import { useOnPageLoad } from '@/ui/hooks/useOnPageLoad';


export default function TagAddPage () {
  // Const & View Model
  const { tagsInTodo, addTagsInTodo, addPostTagIds } = useEditTodoViewModel()
  ...
  // While on this page.
  const AddTagsOfCheckedInCreateTodoParams = {
    ...
    <main className='flex min-h-screen flex-col items-center justify-between p-24'>
      ...
      <div className='flex place-items-center'>
        ...
        <div className="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-4 lg:text-left">
          <button className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded mt-4 inline-block" onClick={() => AddTagsOfCheckedInCreateTodo(AddTagsOfCheckedInCreateTodoParams)}>Add Checked Tags</button>
